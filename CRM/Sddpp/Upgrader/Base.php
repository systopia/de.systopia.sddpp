 ...
 */
class CRM_Sddpp_Upgrader_Base {

  /**
   * @var CRM_Sddpp_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Sddpp_Upgrader(
        'de.systopia.sddpp',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Sddpp_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Sddpp_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
